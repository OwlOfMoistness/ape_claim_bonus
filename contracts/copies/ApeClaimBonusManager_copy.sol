...
import"./ApeClaimBonus_copy.sol";

interface IClaim {
	function claim() external;
}

contract ApeClaimBonusManager2 is Ownable {
	...
	IGrape public GRAPE = IGrape(0x025C6da5BD0e6A5dd1350fda9e3B6a614B205a1F);
	IERC20 public APE = IERC20(0x4d224452801ACEd8B2F0aebE155379bb5D594381);
	IERC721Enumerable public ALPHA = IERC721Enumerable(0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D);
	IERC721Enumerable public BETA = IERC721Enumerable(0x60E4d786628Fea6478F785A6d7e704777c86a7c6);
	IERC721Enumerable public GAMMA = IERC721Enumerable(0xba30E5F9Bb24caa003E9f2f0497Ad287FDF95623);
	...
	constructor(address _ape, address _apeClaim, address _a, address _b, address _g) {
		GRAPE = IGrape(_apeClaim);
		APE = IERC20(_ape);
		ALPHA = IERC721Enumerable(_a);
		BETA = IERC721Enumerable(_b);
		GAMMA = IERC721Enumerable(_g);
	}
